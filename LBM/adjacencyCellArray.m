function [ AdjaCell,netpara ] = adjacencyCellArray(Timeseries,W,K,thres)
...
for t=(W+1):(T-W)  
    AdjaCell{t}=adjac_generator(t,thres);
end
...
% This function generates the Adjacency matrix within the window at time t
    function [ Adj] = adjac_generator(t,thres)
