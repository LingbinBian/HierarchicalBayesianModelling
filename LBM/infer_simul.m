function [] = infer_simul(subid,W,S,K,n_s,thres)
...
[AdjaCell,netpara]=adjacencyCellArray(Timeseries,W,K,thres);
...
elseif thres==1
   Inference_LR=fullfile(Inference_path,'Global_fitting_thres_synthetic',['infer_synthetic','_K',num2str(K),'_W',num2str(2*W),'_n',num2str(n_s)],subid,'infer_simul');
   save(Inference_LR,'cumenergy','K','W');
end
