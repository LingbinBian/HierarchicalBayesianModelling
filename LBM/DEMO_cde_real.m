    ...
    if thres==1
        if session_n==1
          %  subdir_path=fullfile(data_path,'Inference/infer_tfMRI',subid,'inference_WM_LR');
            subdir_path=fullfile(data_path,'Global_fitting_thres_real',['infer_tfMRI','_','K',num2str(K),'_','W',num2str(2*W),],subid,'inference_WM_LR');
            load(fullfile(subdir_path,'infer_LR.mat')); 
        elseif session_n==2
           % subdir_path=fullfile(data_path,'Inference/infer_tfMRI',subid,'inference_WM_RL');
            subdir_path=fullfile(data_path,'Global_fitting_thres_real',['infer_tfMRI','_','K',num2str(K),'_','W',num2str(2*W),],subid,'inference_WM_RL');
